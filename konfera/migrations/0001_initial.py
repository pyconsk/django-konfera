# -*- coding: utf-8 -*-
# Generated by Django 1.10.1 on 2016-10-03 09:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True)),
                ('price', models.DecimalField(decimal_places=2, max_digits=12, validators=[django.core.validators.MinValueValidator(0)])),
                ('attendee_type', models.CharField(choices=[('volunteer', 'Volunteer'), ('press', 'Press'), ('attendee', 'Attendee'), ('supporter', 'Supporter'), ('sponsor', 'Sponsor'), ('aid', 'Aid')], default='attendee', max_length=32)),
