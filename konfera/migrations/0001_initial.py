    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('duration', models.IntegerField(choices=[(5, '5 min'), (30, '30 min'), (45, '45 min')], help_text='Talk duration in minutes.')),
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='konfera.Event')),
                ('primary_speaker', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='primary_speaker_talks', to='konfera.Speaker')),
                ('secondary_speaker', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='secondary_speaker_talks', to='konfera.Speaker')),
            ],
        ),
        migrations.CreateModel(
            name='Ticket',
