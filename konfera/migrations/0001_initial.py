# -*- coding: utf-8 -*-
# Generated by Django 1.10.1 on 2016-09-29 07:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=128)),
                ('capacity', models.IntegerField(blank=True)),
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='rooms', to='konfera.Location')),
            ],
        ),
        migrations.CreateModel(
            name='Schedule',
