# -*- coding: utf-8 -*-
# Generated by Django 1.10.1 on 2016-10-04 13:51
...
>>>>>>> 3b25543c98d15696dcb4be10829065ea5c82ce91
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('accessibility', models.CharField(choices=[('public', 'Public'), ('private', 'Private'), ('disabled', 'Disabled')], default='private', max_length=32)),
                ('usage', models.IntegerField(default=10, help_text='Amount of tickets that can be issued.')),
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='konfera.Event')),
            ],
            options={
                'abstract': False,
        ...
        migrations.AddField(
            model_name='event',
            name='location',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='events', to='konfera.Location'),
        ),
        migrations.AddField(
            model_name='event',
            name='sponsors',
