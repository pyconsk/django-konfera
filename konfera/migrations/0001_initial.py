# -*- coding: utf-8 -*-
# Generated by Django 1.10.1 on 2016-09-28 07:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=128)),
                ('capacity', models.IntegerField(blank=True)),
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='room_locations', to='konfera.Location')),
            ],
        ),
        migrations.CreateModel(
            name='Schedule',
