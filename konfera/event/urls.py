...
urlpatterns = [
    ...
    url(r'^order/(?P<order_uuid>[\w, -]+)/$', views.EventOrderDetailView.as_view(), name='order_details'),
    url(r'^order/(?P<order_uuid>[\w, -]+)/edit/$', views.EventOrderDetailFormView.as_view(), name='order_details_edit'),
    url(r'^order/(?P<order_uuid>[\w, -]+)/pdf/$', views.EventOrderDetailPDFView.as_view(), name='order_details_pdf'),
